...
\[
  m_W = \tfrac{g v}{2}
\]
The $Z$ picks up an analogous mass set by $g$ and $g'$. A single vacuum scale $v$ controls them both.
\end{frame}

\begin{frame}{Fermion Masses}
\centering
Yukawa term $-y_f\, \bar{\psi}_L \Phi \psi_R + \text{h.c.}$ turns the VEV into mass.
\[
